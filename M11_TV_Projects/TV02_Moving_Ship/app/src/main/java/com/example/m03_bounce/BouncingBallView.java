...
//        Log.w("BouncingBallLog", "Just added another bouncing ball");
        ...
        ship_01 = new Ship( Color.WHITE, 300, 800, 0, 0);
//        p2 = new Ship( Color.WHITE, 1600, 400, 0, 0);
...
//            b.moveWithCollisionPaddle(p1);
        ...
        ship_01.draw(canvas);
//        p2.draw(canvas);
        ship_01.moveWithCollisionDetection(box);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                ball_1.dX += deltaX * scalingFactor;
                ball_1.dY += deltaY * scalingFactor;
