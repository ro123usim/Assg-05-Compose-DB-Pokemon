...
@Composable
private fun Greeting(name: DataModel) {
    Card(
...
@Composable
private fun CardContent(name: DataModel) {
    ...
    Row(
        ...
        Column(
            ...
            Text(text = "Hello, ") // leave in the hello
            Text(
                // Just the name of this record
                text = name.modelName, style = MaterialTheme.typography.headlineMedium.copy(
